...
const EVENTS=[
  ...
  {date:"2026-10-04",sectorIds:["power-kodex","power-tiger","semi","quantum","optical"],label:"OPEC+",watch:"유가→물가→금리→고밸류 성장주"},
  ...
  {date:"2026-10-14",sectorIds:["quantum","optical","power-kodex","power-tiger","semi","cyber","space","smr"],label:"미국 CPI",watch:"금리·DXY·성장주 밸류에이션"}
];
