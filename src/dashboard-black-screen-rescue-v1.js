...
.wrap,#gnRoot,#app,main{visibility:visible!important;opacity:1!important}
</style>
<script id="gn-black-screen-rescue-runtime-v1">(function(){
function rescue(){
  document.documentElement.style.visibility='visible';
  document.documentElement.style.opacity='1';
  if(document.body){document.body.style.visibility='visible';document.body.style.opacity='1';document.body.style.display='block';}
