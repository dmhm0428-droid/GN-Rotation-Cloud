...
const preloads=["etf-dashboard-patch.js","dashboard-marker-patch.js","trade-plan-dashboard-patch.js","okx-trading-dashboard-patch.js","top3-policy-patch.js","investment-assistant-dashboard-patch.js","final-dashboard-patch.js"].map(x=>path.resolve(__dirname,x));
